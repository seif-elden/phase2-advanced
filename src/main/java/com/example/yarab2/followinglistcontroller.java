...
public class followinglistcontroller implements Initializable {
    ...
    private profile usertoshowfollowing;
    ...
    public void initData(profile p) {
        this.usertoshowfollowing = p;
        setupButtonActions();
        showusers();
    }
    ...
    private void showusers(){
        ...
        allusers.setItems(javafx.collections.FXCollections.observableArrayList(this.usertoshowfollowing.getFollowlist()));
